  ...
  return (
    <>
      { filteredAndSortedPosts?.map((p, i) =>
        ...
        <div key={i} className="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-12 xl:col-span-12 ">
      ...
      height={82} />
                  ...
                  <div className="col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-8 xl:col-span-8 ">
                    <div className="flex flex-col h-full p-3 ">
                      ...
                      <a href="#" className="text-lg font-semibold  text-gray-600 dark:text-slate-200 block leading-5 truncate hover:underline hover:underline-offset-[4px]">
                        {p.title}
                      </a>
                    </div>{/*end card-body*/}
                  </div>{/*end col*/}
